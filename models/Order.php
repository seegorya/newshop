...
class Order
{
    ...
    public static function save($userName, $userPhone, $userComment, $userId, $products)
    {
        ...
        $db = Db::connect();
echo $userComment.', '.$userId.', '.$userName.', '.$userPhone.', '.$products;

        $sql='INSERT INTO prodorder (user_name, user_phone, user_comment, user_id, prods, status) VALUES '
                .'(:user_name, :user_phone, :user_comment, :user_id, :prods, 0) ';        
        ...
        $result->bindParam(':prods', $products, PDO::PARAM_STR);
    ...
    public static function getOrdersList()
    {
        ...
        $result = $db->query('SELECT id, user_name, user_phone, date, status FROM prodorder ORDER BY id DESC');
        $ordersList = array();
        $i = 0;
    ...
    public static function getOrderById($id)
    {
        ...
        // Текст запроса к БД
        $sql = 'SELECT * FROM prodorder WHERE id = :id';
    ...
    public static function deleteOrderById($id)
    {
        ...
        // Текст запроса к БД
        $sql = 'DELETE FROM prodorder WHERE id = :id';
