            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <textarea name="decs"><?php echo $product['decs']; ?></textarea>
                        
                        <br/><br/>

                        <p>Наличие на складе</p>
                        <select name="availab">
                            <option value="1" <?php if ($product['availab'] == 1) echo ' selected="selected"'; ?>>Да</option>
                            <option value="0" <?php if ($product['availab'] == 0) echo ' selected="selected"'; ?>>Нет</option>
                        </select>
                        ...
                        <p>Рекомендуемые</p>
                        <select name="isrec">
                            <option value="1" <?php if ($product['isrec'] == 1) echo ' selected="selected"'; ?>>Да</option>
                            <option value="0" <?php if ($product['isrec'] == 0) echo ' selected="selected"'; ?>>Нет</option>
                        </select>
